	...
	<body class="app sidebar-mini rtl">
		...
		<div class="page">
          ...
          <ul class="side-menu">
            ...
            <li class="slide">
              <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon si si-docs"></i><span class="side-menu__label">Laporan Kegiatan</span><i class="angle fas fa-angle-right"></i></a>
              <ul class="slide-menu">
                <li><a class="slide-item" href="<?php echo base_url('laporan/Laporan-Ibu-Hamil.html') ?>">Laporan Ibu Hamil</a></li>
                <li><a class="slide-item" href="<?php echo base_url('laporan/Laporan-Balita.html') ?>">Laporan Balita</a></li>
              </ul>
			</li>
			<li>
