...
<div class="side-app">
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="<?php echo base_url('vitamin/Vitamin.html') ?>">Daftar Jenis Imunisasi</a></li>
                  ...
                  <form role="form" action="<?php echo site_url('admin/vitaminInputAction') ?>" method="post">
                      <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" readonly class="form-control" placeholder="Nama Vitamin" value="<?= $nama_imun; ?>" name="nama_imun" required>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                    ...
                    <div class="text-center">
                          ...
                          <a href="<?php echo base_url('imunisasi/Imunisasi.html'); ?>" class="btn btn-secondary">Kembali</a>
                    </div>
