              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?php echo base_url('admin/detailPasienBayi/').$data->id_balita; ?>" class="mr-3" data-toggle="tooltip" title="" data-original-title="Detail"><i class="fe fe-file text-dark fs-16"></i></a>
                    <a href="<?php echo base_url('admin/updatePasienBayi/').$data->id_balita; ?>" class="mr-3" data-toggle="tooltip" title="" data-original-title="Edit"><i class="fe fe-edit-2 text-dark fs-16"></i></a>
                    <a href="<?php echo base_url('admin/deletePasienBayi/').$data->id_balita; ?>" onclick="return confirm('Apakah anda yakin untuk menghapus?');" class="mr-3" data-toggle="tooltip" title="" data-original-title="Delete"><i class="fe fe-trash-2 text-dark fs-16"></i></a>
                    <a href="<?php echo base_url('admin/posyanduPasienBayi/').$data->id_balita; ?>" class="mr-3" data-toggle="tooltip" title="" data-original-title="Cek Posyandu"><i class="fe fe-shield text-dark fs-16"></i></a>
                  </td>
                </tr>
                <?php endforeach ?>
              </tbody>
