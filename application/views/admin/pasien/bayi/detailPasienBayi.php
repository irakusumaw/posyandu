    ...
    <div class="card">
		<div class="card-body">			
			<div class="row">				
					...
					<a href="<?php echo base_url('admin/posyanduPasienBayi/').$data->id_balita; ?>" class="btn btn-secondary" data-toggle="tooltip" title="" data-original-title="Input Penyuluhan">Input Penyuluhan</a>
					</div>
