								...
								<div class="card-group mb-0">
									<div class="card p-4">
										<div class="card-body">
                                            ...
                                            <form role="form" action="<?php echo site_url('auth/gantipassword') ?>" method="post">
											<div class="form-group">
												<label class="form-label text-left" for="exampleInputEmail1">Password</label>
												<input type="password" class="form-control" id="password1"  placeholder="Enter new password" name="password1">
												<?php echo form_error('password1', '<div class="text-danger small ml-3"> ', '</div>')?>
											</div>
											<div class="form-group">
												<label class="form-label text-left" for="exampleInputEmail1">Konfirmasi Password</label>
											...
											<div class="text-left text-muted mt-3"><a href="<?php echo base_url('auth/login') ?>">Kembali ke Login</a>
											</div>
									...
									<div class="card  py-5 d-md-down-none">
										<div class="card-body align-items-center">
											<div>
												...
												<p class="text-muted text-center"><?= $this->session->userdata('reset_email'); ?></p>
