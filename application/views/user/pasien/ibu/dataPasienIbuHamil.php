            ...
            <table id="example-2" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <td class="text-center">
                  <a href="<?php echo base_url('User/detailDataIbuHamil/').$data->id_ibuhamil; ?>" class="mr-3" data-toggle="tooltip" title="" data-original-title="Detail"><i class="fe fe-file text-dark fs-16"></i></a>
                  <a href="<?php echo base_url('User/editDataIbuHamil/').$data->id_ibuhamil; ?>" class="mr-3" data-toggle="tooltip" title="" data-original-title="Edit"><i class="fe fe-edit-2 text-dark fs-16"></i></a>
                </td>
              </tr>
               <?php endforeach ?>
              <!-- <?php
              ...
              ?>
                ...
                <td> <?php echo $data->umur; ?> Tahun </td>
                <td class="text-center">
                  <a href="<?php echo base_url('User/detailPasienIbuHamil/') ?>" class="mr-3" data-toggle="tooltip" title="" data-original-title="Detail"><i class="fe fe-file text-dark fs-16"></i></a>
                  <a href="<?php echo base_url('User/updatePasienIbuHamil/') ?>" class="mr-3" data-toggle="tooltip" title="" data-original-title="Edit"><i class="fe fe-edit-2 text-dark fs-16"></i></a> -->
                  ...
                  <a href="<?php echo base_url('pasien/Posyandu-Pasien-Ibu-Hamil.html'); ?>" class="mr-3" data-toggle="tooltip" title="" data-original-title="Posyandu"><i class="fe fe-shield text-dark fs-16"></i></a> -->
                <!-- </td> -->
              <!-- <?php endforeach ?> -->
              </tbody>
            </table>
